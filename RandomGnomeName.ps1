...
$MultipleSyllableRoots = @("apple","bibble","bobbin","bumble","chibi","chin","diddy","dimple","dingle","dumble","giggle","gummy","hiccup","itchker","mingle","nipper","nibble","ninny","nimble","noggin","patter","pebble","pepper","piddle","pitter","riffle","scoot","silly","skip","sniff","sugar","thimble","tickle","tingle","tinkle","toddle","tom","trib","tummy","tummytum","wiggle","willy","winkle")
$Roots = @()
...
$RockNouns = @("beard","bell","book","bottle","brass","button","candle","candy","cane","cap","cavern","chime","clock","clog","coal","copper","craft","crystal","dingle","drip","fault","finger","fire","fizzle","flux","fumble","fungus","gear","gem","glimmer","glove","grub","hammer","hour","ink","jewel","key","lantern","law","ledger","lesson","letter","light","link","lock","lore","metal","mine","name","needle","nubbin","paper","pinky","print","quill","quiver","rock","ruby","ruin","rule","root","seal","shoe","shovel","shroom","song","screw","soup","spell","spring","song","stamp","steam","stone","story","study","sugar","thimble","thorn","thread","thumb","time","toe","tongue","tooth","tummy","tunnel","water","wax","wit","well","whistle","worm","wrench")
$RockAgents = @("belly","bender","berger","binder","breaker","brow","buffer","caster","catcher","chiller","climber","cooker","counter","crafter","cutter","digger","dinger","dripper","dropper","file","finder","fixer","frolic","goggles","helmer","hemmer","heimer","hider","holder","home","hopper","-inker","-itcher","joker","judger","keeper","kicker","knocker","locker","lover","monch","picker","polish","prank","printer","puller","pusher","presser","maker","mender","miner","noggin","reader","rooter","scamp","sealer","seeker","setter","shaper","signer","sinker","snatcher","snipper","speaker","spinner","stamper","taster","teacher","teller","tender","thrower","tinker","tricker","tucker","twitcher","watcher","witcher","worker","writer")
