...
$ForestPlants = @("berry","birch","bush","cedar","clover","elm","fern","flower","fig","fir","fruit","fungus","hazel","hemlock","holly","ivy","lilly","maple","moss","mushroom","nettle","oak","pansy","pine","shroom","shrub","truffle","tree","willow","yew")
