...
$Prefixes = @("blink","rich")
$OneSyllableRoots = ("bib","big","bit","bob","bum","chit","cub","cup","did","dink","fib","flub","gig","glib","gum","hop","ingle","ink","jig","ken","ker","kin","kirk","link","lump","nab","nib","nip","nub","peck","pib","plump","plunk","pop","riff","tiff","tink","tum","wig","wink")
